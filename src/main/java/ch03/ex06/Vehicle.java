...
class Vehicle {
    ...
    public Vehicle(int currentVelocity, double direction, String ownerName) {
        this(currentVelocity,direction,ownerName,false);
    }

    public Vehicle(int currentVelocity, double direction, String ownerName, boolean isElectrical) {
        ...
        if (isElectrical) {
            this.energySource = new Battery();
        } else {
            this.energySource = new GasTank();
        }
    }
    ...
    public boolean canStart(){
        return !this.energySource.isEmpty();
    }

    public void runOneKilometer(){
        this.energySource.use(10);
    }

    public void changeSpeed(int speed) {
        this.energySource.use(5);
